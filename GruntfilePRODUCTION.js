module.exports = function ( grunt ) {
      ...
      build_prod_settings: {
        files: [
          { 
            ...
            src: ['<%= app_files.productionSettings %>'],
            dest: '<%= build_dir %>/assets/',
            cwd: '.',
            expand: true,
            flatten: true
      ...
      build_dev_settings: {
        files: [
          { 
            ...
            src: ['<%= app_files.developmentSettings %>'],
            dest: '<%= build_dir %>/assets/',
            cwd: '.',
            expand: true,
            flatten: true
  ...
  grunt.registerTask( 'build', [
    ...
    'concat:build_css', 'copy:build_app_assets', 'copy:build_dev_settings' ,'copy:build_prod_settings','copy:build_vendor_assets',
